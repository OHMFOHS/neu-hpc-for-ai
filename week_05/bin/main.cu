/**********************************************************************
 * FlashAttention-2 (Educational CUDA version + Validation)
 * 
 *  - Implements §3.1 Algorithm (forward/backward)
 *  - Implements §3.2 Parallelism (rows/cols blocking)
 *  - Implements §3.3 Warp partitioning (split-Q)
 * 
 *  Includes CPU baseline check: verifies GPU correctness within 1e-6.
 *********************************************************************/
